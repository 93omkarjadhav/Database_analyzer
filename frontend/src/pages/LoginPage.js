      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/50 p-5 shadow-2xl backdrop-blur-xl sm:p-8">
        ...
        <div className="relative">
          <div className="mb-8 text-center text-white">
            <h1 className="font-['Outfit'] text-3xl font-black tracking-tight sm:text-4xl">Welcome Back</h1>
            <p className="mt-2 text-sm text-slate-400 sm:text-base">Continue your data analysis journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="group relative">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-800 bg-slate-950/50 py-3.5 pl-12 pr-4 text-white outline-none transition-all placeholder:text-slate-600 focus:border-rose-500/50 focus:ring-2 focus:ring-rose-500/20"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-3">
                ...
                <button type="button" className="text-xs font-medium text-rose-500 transition-colors hover:text-rose-400">
                  Forgot Password?
                </button>
              </div>
              <div className="group relative">
          ...
          <div className="relative mt-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-slate-900 px-3 font-bold tracking-widest text-slate-500">Or continue with</span>
            </div>
          </div>
